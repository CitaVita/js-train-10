...
function customEntries(obj) {
  ...
  const entries = Object.enteries(obj);
...
function extendAndFreezeObject(obj1, obj2) {
  ...
  console.log("До заморожування:", extendedObject);
  Object.freeze(extendedObject); 
 // Перевіряємо, чи об'єкт "заморожено"
  // Повертаємо "заморожений" об'єкт, якщо все пройшло успішно
   if (Object.isFrozen(extendedObject)) {
    console.log("Об'єкт успішно заморожено");
    return extendedObject;
  } else {
 // Повертаємо повідомлення про помилку, якщо об'єкт не було "заморожено"
 console.log("Помилка: Об'єкт не був заморожений.");
